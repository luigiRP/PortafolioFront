...
import cvtxt from './Luis Rosales (Es).pdf'
        ...
        <section id="cv">
          ...
          <div id="skills">
            ...
            <div className="carta">
              ...
              <p className="descripcion">HTML, CSS, Bootstrap, Javascript, React, Python, Flask, SQL, SQLAlchemy, C++, Dart, Flutter, Shelf</p>
